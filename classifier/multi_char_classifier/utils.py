...
def save_checkpoint(model, optimizer, epoch, val_loss, checkpoint_path, class_names, model_config):
    ...
    Args:
        ...
        class_names (list[str]): List of class_names in correct order (0 index is blank class)
        model_config (dict): Parameters required to instantiate the model
    """
    checkpoint = {
        'epoch': epoch,
